...
tmux bind-key -n C-j if-shell "$is_vim" "send-keys C-j" "select-pane -U"
...
tmux bind-key -T copy-mode-vi C-j select-pane -U
tmux bind-key -T copy-mode-vi C-k select-pane -D
